...
# Anton Dahlén, updated 2023-10-15
...
def parsearguments(argv):
	...
	parser.add_argument('-q', '--quiet', action='store_true', default=False, dest='quiet', help='suppress output')
...
def checktracks(file, tolerance):
...
if __name__ == '__main__':
	def main(argv):
		...
		for file in files:
			verification_passed, audio_tracks, time_string = checktracks(file, tolerance)
